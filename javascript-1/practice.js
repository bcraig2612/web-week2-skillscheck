...
// Code Here
var filtered = myNumbers.filter(function(e){
  return e > 100; 
});
...
// Code Here
var total = myNumbers.reduce(function(acc, val) {
  return acc + val;
})
console.log(total);
//////////////////PROBLEM 17////////////////////
...
// Code Here
forTheLoveOfGeorge = notGeorge.map(function(e){
  if(e != "George")
  return "George"
  });
...
const totallyAwesome = people.reduce(function(total, current) {
